...
#define FFMPEG_CONFIGURATION "--prefix=/Users/danny/Documents/company_code/yoyo_code/android_philm/Philm/ReMediaCore/thirdparty/ffmpeg-3.4.1/../../src/main/jni/ffmpeglib/armeabi-v7a --enable-thumb --enable-runtime-cpudetect --cross-prefix=/Users/danny/Development/android-ndk//toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --target-os=android --enable-cross-compile --sysroot=/Users/danny/Development/android-ndk//platforms/android-18/arch-arm/ --disable-debug --disable-shared --enable-static --enable-asm --enable-neon --enable-gpl --disable-encoders --disable-decoders --disable-muxers --disable-demuxers --disable-parsers --disable-bsfs --disable-protocols --disable-indevs --disable-programs --disable-ffmpeg --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-symver --disable-v4l2_m2m --disable-postproc --disable-filter=showcqt --disable-network --enable-avcodec --enable-avformat --enable-avutil --enable-swscale --enable-swresample --enable-avresample --enable-avfilter --enable-pic --enable-nonfree --enable-small --enable-libx264 --enable-libfdk-aac --enable-zlib --enable-demuxer=mpegts --enable-demuxer=mov --enable-demuxer=flv --enable-demuxer=image2 --enable-demuxer=mp3 --enable-muxer=mpegts --enable-muxer=mp4 --enable-muxer=mp3 --enable-protocol=file --enable-decoder=mjpeg --enable-decoder=mp3 --enable-decoder=h264 --enable-decoder=libfdk_aac --enable-encoder=libx264 --enable-encoder=libfdk_aac --enable-parser=h264 --enable-parser=aac --enable-muxer=gif --enable-encoder=gif --enable-demuxer=rawvideo --enable-decoder=rawvideo --enable-pthreads --enable-jni --enable-mediacodec --extra-cflags='-fdata-sections -ffunction-sections -fstack-protector-strong -ffast-math -fstrict-aliasing -march=armv7-a -mtune=cortex-a8 -mfloat-abi=softfp -mfpu=vfpv3-d16 -D__ANDROID_API__=18 --sysroot /Users/danny/Development/android-ndk//sysroot -isystem /Users/danny/Development/android-ndk//sysroot/usr/include/arm-linux-androideabi -I/Users/danny/Documents/company_code/yoyo_code/android_philm/Philm/ReMediaCore/thirdparty/ffmpeg-3.4.1/third/include/' --extra-ldflags='-Wl,--gc-sections -Wl,-z,relro -Wl,-z,now -Wl,--fix-cortex-a8 --sysroot /Users/danny/Development/android-ndk//platforms/android-18/arch-arm,-rpath-link=/Users/danny/Development/android-ndk//platforms/android-18/arch-arm//usr/lib -L/Users/danny/Development/android-ndk//platforms/android-18/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog -L/Users/danny/Documents/company_code/yoyo_code/android_philm/Philm/ReMediaCore/thirdparty/ffmpeg-3.4.1/third/lib/' --arch=arm --cpu=armv7-a --enable-armv5te --enable-armv6 --enable-vfp --enable-neon"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/danny/Documents/company_code/yoyo_code/android_philm/Philm/ReMediaCore/thirdparty/ffmpeg-3.4.1/../../src/main/jni/ffmpeglib/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/danny/Documents/company_code/yoyo_code/android_philm/Philm/ReMediaCore/thirdparty/ffmpeg-3.4.1/../../src/main/jni/ffmpeglib/armeabi-v7a/share/ffmpeg"
